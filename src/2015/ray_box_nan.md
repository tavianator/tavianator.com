...
[*fa-solid fa-circle-chevron-left* Part 1](../2011/ray_box.md)
*fa-regular fa-clock* *time-2015-03-23*
*fa-solid fa-user* Tavian Barnes
[*fa-solid fa-comment* Comments](#comments)
[*fa-brands fa-reddit* Reddit](https://reddit.com/r/GraphicsProgramming/comments/338n9k/fast_branchless_raybounding_box_intersections/)
[Part 3 *fa-solid fa-circle-chevron-right*](../2022/ray_box_boundary.md)
...
> *fa-regular fa-clock* *time-2015-11-20*
>
...
>
> > <a id="comment-2"></a>*fa-solid fa-user* [**Tavian Barnes**](/)
...
> > > *fa-regular fa-clock* *time-2015-12-03*
> > >
> > > Oh gee, thanks man!
> > > Awesome work.

> <a id="comment-4"></a>**Anna**
> *fa-regular fa-clock* *time-2017-02-08*
>
> Hi!
> Why is this article using "return tmax > tmin" rather then "return tmax >= tmin" from the previous article?
>
> > <a id="comment-5"></a>*fa-solid fa-user* [**Tavian Barnes**](/)
> > *fa-regular fa-clock* *time-2017-02-18*
> >
...
> > > *fa-regular fa-clock* *time-2018-05-28*
> > >
> > > Nice article.
...
> *fa-regular fa-clock* *time-2018-08-02*
>
> Hi, \
...
> > *fa-regular fa-clock* *time-2019-03-25*
> >
> > YES! \
...
> *fa-regular fa-clock* *time-2018-09-09*
>
